...
def communication_decode():
    """Decode instructions from host computer
    """
    global Pre_Cruising_Flag
    global Cruising_Flag
    print('Control: Communication_decoding...')
    if buffer[0]=='00':         # Motor control
        if buffer[1]=='01':
            motor_forward()
        elif buffer[1]=='02':
            motor_backward()
            ...
            motor_stop()
    elif buffer[0]=='02':       # Speed control
        if buffer[1]=='01':     # Left speed
            ena_speed(buffer[2])
        elif buffer[1]=='02':   # Right speed
            enb_speed(buffer[2])
    elif buffer[0]=='01':
        ...
        while True:
            ...
            if rec_flag == 0:
                ...
                if data == 'ff':
                    ...
                    if i == 3:
                        print
                        'Got data', str(buffer)[1:len(str(buffer)) - 1], "\r"
